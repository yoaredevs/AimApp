...
local function processNotifQueue()
    ...
    lucideIcon(notifIcon, data.icon, Color3.fromRGB(255, 255, 255), 18)

    create("TextLabel", {
        Parent = card, BackgroundTransparency = 1,
        Position = UDim2.new(0, 38, 0, 7), Size = UDim2.new(1, -50, 0, 19),
    ...
    create("TextLabel", {
        Parent = card, BackgroundTransparency = 1,
        Position = UDim2.new(0, 12, 0, 28), Size = UDim2.new(1, -24, 0, 22),
...
do
            ...
            if not player.Parent then
                ...
                if not (char and head and root and alive) then
                    ...
                    if data.highlight then
                        local c = sameTeam and Color3.fromRGB(150, 152, 160) or espColor
    ...
    newToggle(scroll, {
        text = "Team Check (cinza = aliado)", icon = "users", iconColor = CONFIG.InfoColor,
...
do
    ...
    local function createPlayerCard(player, order)
        ...
        newIconButton(card, {
            ...
            size = UDim2.new(0, 86, 0, 26), position = UDim2.new(0, 8, 0, 44),
            onClick = function()
        ...
        newIconButton(card, {
            ...
            size = UDim2.new(0, 86, 0, 26), position = UDim2.new(0, 100, 0, 44),
            onClick = function()

...
local function processNotifQueue()
    ...
    local notifColor = (data.icon == "triangle-alert" or data.icon == "alert-triangle") and CONFIG.WarningColor
        or (data.icon == "check" or data.icon == "check-circle-2") and CONFIG.SuccessColor
...
do
    ...
    local function setFly(state)
        ...
        if state and root then
            ...
            flyConn = RunService.RenderStepped:Connect(function()
                local cam = workspace.CurrentCamera
                if not cam or not flyBodyVel or not flyBodyVel.Parent then return end
                ...
                flyBodyVel.Velocity = moveDir.Magnitude > 0 and moveDir.Unit * 60 or Vector3.new(0, 0, 0)
            end)
    ...
    makeToggle("Fly", false, "wind", 3, setFly)

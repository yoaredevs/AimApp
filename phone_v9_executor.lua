...
do
    ...
    local function makeSlider(labelText, min, max, default, icon, order, onChange)
        ...
        lucideIcon(iconHolder, icon, CONFIG.InfoColor, 18)
        ...
        local fill = create("Frame", {
            Parent = track, Size = UDim2.new(rel, 0, 1, 0), BackgroundColor3 = CONFIG.InfoColor,
        }, { corner(3) })
    ...
    local function makeToggle(labelText, default, icon, order, onChange)
        ...
        lucideIcon(iconHolder, icon, CONFIG.WarningColor, 18)
...
do
    ...
    local searchBtn = create("TextButton", {
        ...
        BackgroundColor3 = CONFIG.InfoColor, Text = "Buscar",
    ...
    local function addResultCard(scriptData, order)
        ...
        local function makeActionBtn(xScale, width, bg, label, iconName, callback)
            ...
            lucideIcon(ih, iconName, Color3.fromRGB(255, 255, 255), 15)
        ...
        makeActionBtn(0.03, 0.43, CONFIG.AccentColor, "Copiar", "copy", function()
        ...
        local execBtn
        execBtn = makeActionBtn(0.51, 0.43, Color3.fromRGB(30, 41, 50), "Executar", "play", function()
            withCode(function(code)
...
local function newCycleButton(parent, props)
    ...
    local valueBtn = create("TextButton", {
        ...
        BackgroundColor3 = Color3.fromRGB(35, 48, 60), Text = "", AutoButtonColor = false,
    }, { corner(8) })
...
do
    ...
    local statusValue = create("TextLabel", {
        ...
        BackgroundTransparency = 1, Font = Enum.Font.GothamBold, TextSize = 13,
        TextXAlignment = Enum.TextXAlignment.Left, TextColor3 = CONFIG.SuccessColor, Text = "—",
    }, {})
        ...
        if on then
            ...
            aimConn = RunService.RenderStepped:Connect(function()
                ...
                if target then
                    ...
                    if part then
                        local look = CFrame.lookAt(cam.CFrame.Position, part.Position)
...
do
    ...
    local function createPlayerCard(player, order)
        ...
        local bgHl = highlighted[player] and CONFIG.WarningColor or Color3.fromRGB(35, 48, 60)

...
do
    -- barras de sinal (internet celular)
    local SignalBars = create("Frame", {
        Parent = PhoneFrame,
    ...
    for i, h in ipairs({ 4, 7, 10, 13 }) do
        create("Frame", {
            Parent = SignalBars,
...
do
    ...
    create("TextLabel", {
        Parent = colorCard, Position = UDim2.new(0, 12, 0, 0), Size = UDim2.new(1, -60, 1, 0),
        BackgroundTransparency = 1, Font = Enum.Font.GothamBold, TextSize = 13,
        TextColor3 = CONFIG.TextColor, TextXAlignment = Enum.TextXAlignment.Left,
        Text = "Cor do ESP",
    }, {})
    ...
    local colorSwatch = create("Frame", {
        Parent = colorCard, AnchorPoint = Vector2.new(1, 0.5),
    ...
    newSlider(scroll, {
        text = "Matiz da cor", icon = "sliders", iconColor = CONFIG.InfoColor,
        min = 0, max = 360, default = 198, order = 7,
        format = function(v) return math.floor(v) .. "°" end,
        onChange = function(v)
            espState.hue = v / 360
            espColor = Color3.fromHSV(espState.hue, 0.75, 1)
            colorSwatch.BackgroundColor3 = espColor
        end,
    })
end
...
do
    ...
    create("TextLabel", {
        ...
        Position = UDim2.new(0.5, 0, 0.5, -14), Size = UDim2.new(1, 0, 0, 30),
    ...
    create("TextLabel", {
        Parent = centered, AnchorPoint = Vector2.new(0.5, 0.5),
        Position = UDim2.new(0.5, 0, 0.5, 12), Size = UDim2.new(1, 0, 0, 16),
